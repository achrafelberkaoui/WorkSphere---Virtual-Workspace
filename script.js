...
btnAddExperience.addEventListener("click", () => {
    ...
    newExp.classList.add("experience-row");
    newExp.innerHTML = `
        <label class="form__label">Experience ${index ++}:</label>
    ...
    <button type="button" class="remove-experience">X</button>
    `;
    experienceContainer.appendChild(newExp, btnAddExperience);
    const rmbtn = document.querySelector(".remove-experience");
    // Remove button
